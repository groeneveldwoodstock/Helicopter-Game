...
public class HelicopterForm implements MouseListener, KeyListener
{
    ...
    public void initiate()
    {
        if(!playedOnce)
        {
            background = new JFrame("Groeneveld's Helicopter Game"); 
        ...
        middlerecs.add(new MovingImage("darkcloud.png",1392,randomMidHeight()));
        middlerecs.add(new MovingImage("darkcloud.png",1972,randomMidHeight()));
    ...
    public void updateMiddle()
    {
        ...
        {
            middlerecs.set(0,new MovingImage("darkcloud.png",middlerecs.get(0).getX() - (RECWIDTH/5), middlerecs.get(0).getY()));
            middlerecs.set(1,new MovingImage("darkcloud.png",middlerecs.get(1).getX() - (RECWIDTH/5), middlerecs.get(1).getY()));
        }
        else
        {
            middlerecs.set(0,new MovingImage("darkcloud.png",middlerecs.get(1).getX() - (RECWIDTH/5), middlerecs.get(1).getY()));
            middlerecs.set(1,new MovingImage("darkcloud.png",middlerecs.get(0).getX() + 580,randomMidHeight()));
        }
    }
...
class ImagePanel extends JPanel {
    ...
    public void drawStrings(Graphics g)
    {
        ...
        g.drawString("Hold Mouse Button or Space to Fly Up!     Move Cursor Off Window or Press P to Pause",20,25);
        g.setFont(new Font("Arial",Font.BOLD,30));
        g.drawString("Helicopter Runner! By Mr. Groeneveld",125,70);
        g.setFont(new Font("Arial",Font.BOLD,20));
